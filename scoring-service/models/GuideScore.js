...
const guideScoreSchema = new mongoose.Schema({
  email: {
    type: String,
    required: true,
    unique: true,
...
guideScoreSchema.virtual('totalScore').get(function() {
  return this.calculateScore();
});

// Method to calculate score
guideScoreSchema.methods.calculateScore = function() {
...
guideScoreSchema.index({ email: 1 });
guideScoreSchema.index({ active: 1, banned: 1 });

module.exports = mongoose.model('GuideScore', guideScoreSchema);
